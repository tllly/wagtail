# Generated by Django 6.0.3 on 2026-03-13 03:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='navigationsettings',
            name='whatsapp',
            field=models.CharField(blank=True, help_text='WhatsApp number (e.g., 86138...)', max_length=255),
        ),
        migrations.CreateModel(
            name='Certificate',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='base.inquirypage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
